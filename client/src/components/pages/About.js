    ...
    <div className="about">
      ...
      <div className="about-info">
        <ul className="bullet">
          ...
          <li>
            <i className="fa-solid fa-circle"></i> I earned my <strong>Bachelor of Engineering in Information Technology</strong> from Lukhdhirji Engineering College with a CGPA of <strong>9.0/10</strong>.
          </li>
          <li>
            <i className="fa-solid fa-circle"></i> At <strong>EsparkBiz Technologies</strong>, I delivered performance-optimized MERN applications, boosting engagement by 20% and cutting load time by 15% using chunking and image compression.
          </li>
          <li>
